...
import com.brtbeacon.map3d.demo.map.basic.ZoomMapActivity;
...
public class MapGuideActivity extends BaseActivity {
    ...
    static {
        ...
        {
            GuideItem groupItem = new GuideItem("地图显示");
            groupItem.add(new GuideItem("* 基础地图渲染", SimpleMapActivity.class));
            groupItem.add(new GuideItem("* 楼层控制", FloorMapActivity.class));
            groupItem.add(new GuideItem("* 坐标转换", CoordMapActivity.class));
            groupItem.add(new GuideItem("* 放大缩小", ZoomMapActivity.class));
