...
import com.brtbeacon.map3d.demo.map.annotations.FollowMapActivity;
...
public class MapGuideActivity extends BaseActivity {
    ...
    static {
        ...
        {
            GuideItem groupItem = new GuideItem("覆盖物");
            groupItem.add(new GuideItem("* 地图标点", MarkerMapActivity.class));
            groupItem.add(new GuideItem("* 线标注", PolyLineMapActivity.class));
            groupItem.add(new GuideItem("* 多边形标注", PolygonMapActivity.class));
            groupItem.add(new GuideItem("* 插入文字", LabelMapActivity.class));
            groupItem.add(new GuideItem("* 插入图片", ImageMapActivity.class));
            groupItem.add(new GuideItem("* 信息框", InfoWindowMapActivity.class));
